<div class="sy__outline" style="max-width: 900px; margin: 0 auto;">
    ...
    <div style="margin-top: 2em; padding: 2em; background: linear-gradient(135deg, rgba(102,126,234,0.08), rgba(118,75,162,0.08)); border: 1px solid var(--b3-theme-border); border-radius: 12px; box-shadow: 0 4px 12px var(--b3-theme-shadow);">
        <h2 style="color: var(--b3-theme-primary); margin: 0 0 1em; font-size: 1.5em;">🚀 Latest v0.7.5 (2026.1.12)</h2>
        <div style="margin: 0; line-height: 1.8; color: var(--b3-theme-on-surface);">
            <div style="margin-bottom: 1.5em;">
                ...
                <ul style="margin: 0; padding-left: 1.5em;">
                    <li><strong>Slash Command Quick Insert</strong>: Support /mediaplayer, /sm commands to quickly add media links to current block, built-in segment controller with style options (default/border/card/cover/play), supports batch adding</li>
                    <li><strong>Timestamp Offset Setting</strong>: New timestamp offset setting, allows forward(-)/backward(+) offset by specified seconds when generating timestamps/loop segments</li>
                </ul>
            </div>
            <div style="margin-bottom: 1.5em;">
                <h3 style="color: var(--b3-theme-primary); margin: 0 0 0.5em; font-size: 1.1em;">🐛 Bug Fixes</h3>
                <ul style="margin: 0; padding-left: 1.5em;">
                    <li><strong>Style Pollution Fix</strong>: Fixed ArtPlayer hint.css polluting SiYuan toggle buttons causing blur</li>
                    <li><strong>Bilibili Multi-Part Timestamp Fix</strong>: Fixed inaccurate timestamp generation for Bilibili multi-part videos</li>
                </ul>
            </div>
            <div style="margin-bottom: 1.5em;">
                <h3 style="color: var(--b3-theme-primary); margin: 0 0 0.5em; font-size: 1.1em;">🔧 Improvements</h3>
                <ul style="margin: 0; padding-left: 1.5em;">
                    <li><strong>Settings Group Adjustment</strong>: Renamed settings group "Link & Template" to "Notes & Links", timestamp offset setting moved to this group</li>
                    <li><strong>Plugin Rename</strong>: Chinese name changed from "思源媒体播放器" to "思播-思源媒体播放器"</li>
                </ul>
            </div>
        </div>
    </div>
