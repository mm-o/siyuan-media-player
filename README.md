...
<h3>📅 v0.6.8 Update (2025.10.22)</h3>
<h4>✨ New Features</h4>
<ul>
  <li><strong>☁️ S3 Object Storage Integration</strong>:
    <ul>
      <li>Support for S3 protocol-compatible object storage services (Qiniu Cloud, MinIO, AWS S3, etc.).</li>
      <li>Full support for timestamp links and loop segment jump functions.</li>
    </ul>
  </li>
</ul>
<h4>🐛 Bug Fixes</h4>
<ul>
  <li><strong>📋 Playlist Expansion Fix</strong>:
    <ul>
      <li>Fixed issue where expanded collection lists were obscured in detailed and compact views, ensuring expanded content displays completely.</li>
    </ul>
  </li>
</ul>
